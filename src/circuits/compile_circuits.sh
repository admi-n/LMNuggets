...
circom buyerInfoHashCircuit.circom --r1cs --wasm --json -o ./build/

# setup 
snarkjs groth16 setup ./build/buyerInfoHashCircuit.r1cs ./ptau/powersOfTau28_hez_final_16.ptau ./build/circuit_0000.zkey
...
snarkjs zkey beacon build/circuit_0003.zkey ./build/buyerInfoHashCircuit.zkey 0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f 10 -n="Final Beacon phase2"
# snarkjs zkey verify build/withdraw.r1cs ptau/powersOfTau28_hez_final_16.ptau build/buyerInfoHashCircuit.zkey

snarkjs zkey export verificationkey ./build/buyerInfoHashCircuit.zkey ./build/verification_key.json
snarkjs zkey export solidityverifier ./build/buyerInfoHashCircuit.zkey ./build/verifier.sol